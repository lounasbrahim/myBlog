                    ...
                    <table class="table">
                        ...
                        @foreach( Auth::user()->posts as $post)
                            <tr>
                                ...
                                <td>
                                    <form  id="del-post-{{$post->id}}" action="{{ route('deletePost' , $post->id)}}"  method="POST">
                                        @csrf
                                    </form>
                                    <a href="{{ route("editPost" , $post->id) }}"><button class="btn btn-primary" onclick=""><i class="icon icon-pencil"></i> </button></a>
